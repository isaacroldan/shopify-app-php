...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/profitable-shareholder-ext/src/index.jsx
  ...
  // node_modules/@remote-ui/react/build/esm/error-polyfill.mjs
  if ("importScripts" in globalThis && !("window" in globalThis) && !("document" in globalThis)) {
    class FakeDocument {
      createEvent(type) {
  ...
  extend(
    ...
    render2(() => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}))
  );
  extend(
  ...
  function App() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text2, {
      children: [
        "Welcome to the ",
        extensionPoint,
        " extension!"
